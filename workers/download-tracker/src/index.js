...
COLD-SHELF TETHER: ${HOST}/v1/shelf
    ...
    <script>
      ...
      (function () {
        ...
        function paintMesh(raw) {
          ...
          $("meshProducts").textContent = "Catalog MCP mesh_* · FragGate slug=mesh · /v1/mesh/* PROXY · QNS-CD-1.0 cross-map · SPLIT-THE-WIRES-1.0 · COLD-COPY-SURVIVAL-1.0 · REHEAL-1.0 · COLD-SHELF-TETHER-1.0 · not AnonBroadcast · not AZMail ring · not a Node Gate · no public qnsd proxy" + extra;
        }

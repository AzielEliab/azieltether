...
<body>
  ...
  <div class="card">
    ...
    <p class="meta"><a href="/stats">JSON stats</a> · <a href="/openapi.json">OpenAPI</a> · <a href="/v1/skill">Skill</a> · <a href="/v1/example">Example</a> · <a href="/ai">AI runtime</a> · <a href="/llms.txt">llms.txt</a> · <a href="${GITHUB_LATEST}">releases</a></p>
    <script>
      (function () {
